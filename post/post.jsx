      ...
      <div className="post">
        {(() => {
          switch (this.props.PostType) {
            ...
            case "photo":
              return <PhotoPost {...this.props} />;
            case "quote":
              return <QuotePost {...this.props} />;
            case "video":
              return <VideoPost {...this.props} />;
            case "link":
              return <LinkPost {...this.props} />;
            case "chat":
              return <ChatPost {...this.props} />;
            case "text":
              return <TextPost {...this.props} />;
            case "audio":
              return <AudioPost {...this.props} />;
            default:
              return null;
          }
        })()}
